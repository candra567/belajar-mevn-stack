<template>
    <container-page title="Data Employe">
        <div class="my-2"><button class="btn btn-sm btn-primary" @click="state.activeFormAdd=!state.activeFormAdd">Tambah data</button></div>
...
const getEmployes = () => {
    axios.get(baseUrl).then(res => state.employes = res.data.data)
}
